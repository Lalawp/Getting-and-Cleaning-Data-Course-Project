...
##Description
This codebook describes the data and transformation to that data to create a tidy data set. This was completed for the John Hopkin School of Public Health and Coursera's Getting and Cleaning Data course.
